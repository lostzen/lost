...
public class LocationSettingsResultRequestTest {
  ...
  public void setup() {
    ...
    resultRequest = new LocationSettingsResultRequest(context, bluetoothAdapter, pm,
        locationManager, generator, request);
  }
  ...
  public void await_balancedLowPower_noBle_shouldReturnStatusResolutionRequired() {
    ...
    LocationSettingsRequest settingsRequest = new LocationSettingsRequest.Builder()
        ...
        .setNeedBle(false)
        .build();
    LocationSettingsResultRequest settingsResultRequest = new LocationSettingsResultRequest(context,
  ...
  public void awaitTimeout_shouldTimeoutAfterInterval() {
    ...
    LocationSettingsResultRequest settingsResultRequest = new LocationSettingsResultRequest(context,
        bluetoothAdapter, pm,
        locationManager, delayedGenerator, request);
  ...
  public void cancel_shouldSetIsCanceled() {
    ...
    //assertThat(resultRequest.isCanceled()).isTrue();
  }
